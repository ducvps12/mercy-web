...
const promoLinks = [
  ...
  { icon: Gift, text: "Quà tặng hấp dẫn", color: "text-orange-500", href: "/#" },
];
        ...
        >
          ...
          <div className="relative hidden md:block">
            ...
            {catOpen && (
              <>
                ...
                <div className="absolute top-full left-0 mt-2 w-[320px] bg-white rounded-xl shadow-2xl border border-gray-100 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 p-4">
                  ...
                  <div className="flex flex-col gap-1">
                    {categories.map((cat, i) => (
                      <button
                        key={i}
                        className="flex items-center gap-2 w-full px-3 py-2.5 text-sm text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-lg transition-all duration-150 group/item text-left font-medium"
                        onClick={() => { setCatOpen(false); navigate(cat.href); }}
                      >
                  ...
                  <div className="border-t border-gray-100 mt-4 pt-3">
                    <button
                      className="flex items-center justify-center gap-2 w-full text-sm font-bold text-red-600 hover:text-red-700 py-2 hover:bg-red-50 rounded-lg transition-all"
          ...
          <div className="flex items-center gap-2 ml-auto shrink-0">
            ...
            <button
              ...
              className="relative flex items-center gap-2 bg-white text-[#d70018] px-2.5 md:px-3 py-2 rounded-xl font-bold text-sm transition-all hover:bg-gray-50 active:scale-95 shadow-sm"
            >
        ...
        <div className="container flex items-center justify-between h-11">
          ...
          <div className="flex-none flex justify-center items-center gap-4 lg:gap-8">
            {promoLinks.slice(1).map((link, i) => (
              <div key={i} className="flex items-center gap-1.5 text-xs lg:text-sm font-semibold text-gray-700 whitespace-nowrap">
          ...
          <div className="p-4">
            <form onSubmit={(e) => { handleSearchSubmit(e); setMenuOpen(false); }} className="relative">
              <input
                ...
                className="w-full pl-10 pr-4 py-3 text-sm bg-gray-50 rounded-xl outline-none text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-red-200 border border-gray-200"
                onFocus={() => setSearchFocused(true)}
                onBlur={() => setTimeout(() => setSearchFocused(false), 200)}
          ...
          <div className="px-4 pb-6">
            ...
            <div className="grid grid-cols-2 gap-2">
              <a
                id="mobile-call-now"
                href="tel:0898273899"
                className="flex items-center justify-center gap-2 px-3 py-3 rounded-xl bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition-colors"
              >
          ...
          <div className="bg-white rounded-xl shadow-2xl p-4 md:p-6 w-full max-w-5xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95" onClick={e => e.stopPropagation()}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-100">
                ...
                <p className="text-sm text-gray-600 mb-4 pl-[42px] font-medium">S1.06 Vinsmart City, Nam Từ Liêm, Hà Nội</p>
                <div className="w-full aspect-[4/3] rounded-lg overflow-hidden border border-gray-200">
