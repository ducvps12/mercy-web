...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setLoading(true);
    // Placeholder - sẽ kết nối backend sau
    setTimeout(() => {
      toast.info("Chức năng đăng nhập sẽ được kết nối sau khi bật Lovable Cloud");
      setLoading(false);
    }, 1000);
  };

  const handleGoogleLogin = () => {
    toast.info("Đăng nhập Google sẽ được kích hoạt sau khi bật Lovable Cloud");
  };
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-card rounded-2xl border border-border shadow-lg p-6 md:p-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border-2 border-border bg-background text-foreground font-medium text-sm hover:border-primary/40 hover:shadow-md transition-all duration-200 active:scale-[0.98]"
            >
